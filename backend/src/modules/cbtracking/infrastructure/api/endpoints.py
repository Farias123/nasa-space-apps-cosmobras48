...
from src.modules.cbtracking.infrastructure.services.nasa_proximity_data import (
...
@router.get("/proximity_data", response_model=GenericResponse[CelestialBodyCloseApproachDetails])
@inject
...
@router.get("/closest_object", response_model=GenericResponse[CelestialBodyCloseApproachDetail])
@inject
